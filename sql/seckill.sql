...
CREATE DATABASE IF NOT EXISTS `seckill` DEFAULT CHARACTER SET utf8;
...
CREATE TABLE `sk_user` (
  ...
  `password` varchar(60) DEFAULT NULL COMMENT 'BCrypt hash, 存量数据为MD5(MD5(pass明文+固定salt)+salt)',
...
# SET start_date = '2026-06-01 00:00:00', end_date = '2026-12-31 23:59:59';